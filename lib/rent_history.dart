...
class _RentHistoryPageState extends State<RentHistoryPage>
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildTextField(
                        ...
                        enabled: true,
                        suffixIcon: const Icon(Icons.percent, color: Colors.white), // Add the percentage icon here
                      ),
                    ),
                    ...
                    children: [
                      ...
                      Center(
                        child: AnimatedButton(
                          onPressed: _printRentDetails, // Call the function to save rent details
  ...
  void _fetchOwnerInformation(String contact) async {
    if (selectedMonth != null && selectedYear != null) {
      ...
      // Create the unique ID in the format contact-month-year
      String uniqueId = '$contact-$selectedMonth-$selectedYear';
      DatabaseReference ref = FirebaseDatabase.instance.ref();

      try {
        // Fetch the data from the Realtime Database using the unique ID
        ...
        if (snapshot.exists) {
          ...
          // Fetching and setting values in controllers
          ...
          String formattedDate = DateFormat('yyyy-MM-dd').format(
              parsedDate); // Format the date

          _rentedDateController.text = formattedDate; // Set the formatted date
          ...
          // Fetch and store the total payable amount
          totalPayableAmount = rentData['totalPayableAmount']?.toDouble() ??
              0.0; // Store the total payable amount
