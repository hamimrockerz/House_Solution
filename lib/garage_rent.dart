...
class GarageRentPage extends StatefulWidget {
  const GarageRentPage({super.key});

  @override
  _GarageRentPageState createState() => _GarageRentPageState();
}

class _GarageRentPageState extends State<GarageRentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Garage Rent Management'),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: ListView(
          children: [
            _buildRentButton(context, 'Garage Rent Collect', Icons.money, '/garage_rent_collect'),
            const SizedBox(height: 20), // Space between buttons
            _buildRentButton(context, 'Garage Rent Update', Icons.update, '/garage_rent_update'),
            const SizedBox(height: 20), // Space between buttons
            _buildRentButton(context, 'Garage Rent Details', Icons.garage, '/garage_rent_details'),
            const SizedBox(height: 20), // Space between buttons
            _buildRentButton(context, 'Garage Rent History', Icons.history, '/garage_rent_history'),
          ],
        ),
      ),
    );
